...
<body>
	...
	<div id="container">
				...
				<tbody>
					<tr>
						...
						<td><label class="label1"><form:errors
									path="firstName" class="error" /></label></td>
					</tr>
					<tr>
						<td><label>Last Name (*):</label></td>
						<td><form:input path="lastName" /></td>
						<td><label class="label1"><form:errors
									path="lastName" class="error" /></label></td>
					</tr>
					<tr>
						<td><label>Date of Birth:</label></td>
						<td><form:input path="dateOfBirth" /></td>
						<td><label class="label1"><form:errors
									path="dateOfBirth" class="error" /></label></td>
					</tr>
					<tr>
						<td><label>Email:</label></td>
						<td><form:input path="email" /></td>
						<td><label class="label1"><form:errors path="email"
					...
					<tr>
						...
						<td><label class="label1"><form:errors
									path="phoneNumber" class="error" /></label></td>
					</tr>
					<tr>
						<td><label>PESEL:</label></td>
						<td><form:input path="pesel" /></td>
						<td><label class="label1"><form:errors path="pesel"
									class="error" /></label></td>
					</tr>
					<tr>
						...
						<td><label class="label1"><form:errors
									path="bankAccount" class="error" /></label></td>
					</tr>
					<tr>
		...
		<c:if test="${owner.id!=0}">
			<p>
				<a
					href="${pageContext.request.contextPath}/residence/showDetails?ownerId=${owner.id}">
					Go to Owner Details</a>
			</p>
		</c:if>
		<p>
