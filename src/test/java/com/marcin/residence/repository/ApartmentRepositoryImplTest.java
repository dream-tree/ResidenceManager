...
public class ApartmentRepositoryImplTest {
	...
	public void testGetOwnerApartments() {		
		...
		expectedApartmentId6.setArea(BigDecimal.valueOf(55.0).setScale(2, RoundingMode.UNNECESSARY));
		...
		expectedApartmentId6.setLiabilities(BigDecimal.valueOf(0.00).setScale(2, RoundingMode.UNNECESSARY));
		...
		assertEquals(expectedApartmentId6.getArea(), actualListOwnerId10005.get(2).getArea());
		assertEquals(expectedApartmentId6.getNumberOfRooms(), actualListOwnerId10005.get(2).getNumberOfRooms());
		assertEquals(expectedApartmentId6.getNumberOfOccupants(), actualListOwnerId10005.get(2).getNumberOfOccupants());
		assertEquals(expectedApartmentId6.getWaterConsumption(), actualListOwnerId10005.get(2).getWaterConsumption());
		assertEquals(expectedApartmentId6.getHeaterConsumption(), actualListOwnerId10005.get(2).getHeaterConsumption());
		assertEquals(expectedApartmentId6.getLiabilities(), actualListOwnerId10005.get(2).getLiabilities());
		assertEquals(expectedApartmentId6.getNotes(), actualListOwnerId10005.get(2).getNotes());		
	}
	...
	public void testGetAllApartments() {
		...
		expectedApartmentId5.setArea(BigDecimal.valueOf(55.00).setScale(2, RoundingMode.UNNECESSARY));
		...
		expectedApartmentId5.setLiabilities(BigDecimal.valueOf(0).setScale(2, RoundingMode.UNNECESSARY));
		...
		assertEquals(expectedApartmentId5.getArea(), actualList.get(5).getArea());
		assertEquals(expectedApartmentId5.getNumberOfRooms(), actualList.get(5).getNumberOfRooms());
		assertEquals(expectedApartmentId5.getNumberOfOccupants(), actualList.get(5).getNumberOfOccupants());
		assertEquals(expectedApartmentId5.getWaterConsumption(), actualList.get(5).getWaterConsumption());
		assertEquals(expectedApartmentId5.getHeaterConsumption(), actualList.get(5).getHeaterConsumption());
		assertEquals(expectedApartmentId5.getLiabilities(), actualList.get(5).getLiabilities());
		assertEquals(expectedApartmentId5.getNotes(), actualList.get(5).getNotes());		
	}
}