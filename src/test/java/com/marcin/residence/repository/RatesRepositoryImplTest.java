...
public class RatesRepositoryImplTest {
	...
	public void testGetGetRates() {
		...
		assertEquals(BigDecimal.valueOf(3.90).setScale(2, RoundingMode.UNNECESSARY),
		        actualOwnerRates.getHeatingRate());
		assertEquals(BigDecimal.valueOf(5.50).setScale(2, RoundingMode.UNNECESSARY),
		        actualOwnerRates.getWasteFee());
		assertEquals(BigDecimal.valueOf(8.00).setScale(2, RoundingMode.UNNECESSARY),
		        actualOwnerRates.getTvFee());
	}
}
